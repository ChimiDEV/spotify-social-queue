...
async function handler(req, res) {
    res.status(200).json(await (0,_utils_spotify__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .ZP)(req.query.sid).currentTrack());
};
...
var __webpack_exports__ = __webpack_require__.X(0, [599,774], () => (__webpack_exec__(6672)));
